...
【记忆prompt】是自动从对话中归纳的本项目实操过程中的具体要求和行动准则。[memo.md](docs/rules/memo.md)中保存了【记忆prompt】。
...
- 在执行【plan】【implement】【refactor】相关的任务时，【必须】逐条回答以下问题：
    - 是否有必要执行该任务？现状如何？存在哪些备选方案？它们之间有什么优劣？是否有更好的方案？
    - 该任务完成后解决了什么问题？又带来了什么问题？
    - 该任务是否和当前的设计，文档和代码冲突？是否违背了最佳实践和相关的要求？
